# Generated by Django 2.1.2 on 2018-10-13 23:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fk_cityLocality', to='delivery_organico.City')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.AddField(
            model_name='profile',
            name='address',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fk_addressProfile', to='delivery_organico.Address'),
        ),
        migrations.AddField(
            model_name='profile',
            name='groups',
