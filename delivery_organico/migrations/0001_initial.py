# Generated by Django 2.1.2 on 2018-11-10 04:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_of_card', models.CharField(choices=[('email', 'Email'), ('phone', 'Teléfono'), ('address', 'Dirección'), ('link', 'Link')], max_length=20, verbose_name='Tipo de dato')),
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vcards', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='branch',
        ...
        migrations.AddField(
            model_name='address',
            name='profile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fk_profileAddress', to=settings.AUTH_USER_MODEL),
        ),
    ]
