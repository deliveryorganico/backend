# Generated by Django 2.1.2 on 2018-10-13 17:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fk_branchCompany', to='delivery_organico.Branch')),
            ],
        ),
        migrations.CreateModel(
            name='Favorite',
        ...
        migrations.AddField(
            model_name='city',
            name='locality',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fk_localityCity', to='delivery_organico.Locality'),
        ),
        migrations.AddField(
            model_name='branch',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fk_productBranch', to='delivery_organico.Product'),
        ),
        migrations.AddField(
            model_name='address',
            name='city',
